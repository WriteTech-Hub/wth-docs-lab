...
- Restructure or simplify dense technical content: give AI a complex technical explanation and ask it to reorganise using the Diataxis framework or simplify for a less technical audience
...
[Git](https://git-scm.com/) and [GitHub](https://github.com/) are the standard. [GitLab](https://about.gitlab.com/) and [Bitbucket](https://bitbucket.org/product) are used in some organisations. Knowing Git at a basic level is a prerequisite for most documentation roles.
...
[VS Code](https://code.visualstudio.com/) with a Markdown preview extension, [Typora](https://typora.io/), or [Obsidian](https://obsidian.md/) for writing and editing. [Google Docs](https://workspace.google.com/products/docs/) or [Microsoft Word](https://word.cloud.microsoft/) for collaborative draft review.
...
|:---|:---|:---|
| Technical blog posts | Write about a tool you use, a documentation workflow, or a concept you found difficult to understand. Teaching something is the fastest way to find gaps in your own knowledge. | [WriteTech Hub guest posting](https://writetechhub.org/guest-post-guideline/), [WriteTech Hub blog](https://writetechhub.org/blog/), [Hashnode](https://hashnode.com/), [Medium](https://medium.com/), [Dev.to](https://dev.to/) |
| README improvements | Find an open-source project with a weak README and rewrite it. Open a pull request. Getting it merged is a public contribution; even if it is not merged, the before-and-after is a portfolio piece. | Example repos: [Flask](https://github.com/pallets/flask), [Requests](https://github.com/psf/requests), [Docusaurus](https://github.com/facebook/docusaurus) |
